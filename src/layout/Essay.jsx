	...
	return (
		<Fragment>
			<header className="essay-header">
				<Link to="/adad/#saggi" className="essay-header__menu">
			...
			<div className="essays">
				...
				<div className="essays-list">
				{
					essays && essays.map(essay=>(
						<div key={essay.slug} className="essay-wrapper">
							<div className="essay">
							{
								essay.book_file && (
									<a className="essay-book__link" href={essay.book_file} target="_blank">
							...
							<p className="essay-info">
								<span className="essay-info__comment">{essay.comment}</span><br/>
								{essay.title}.<br/>
